    ...
    <div className="font-[sans-serif]">
      <div className="min-h-screen flex fle-col items-center justify-center py-6 px-4">
        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div>
            {loading ? (<h2 className="lg:text-5xl text-4xl font-extrabold lg:leading-[55px] text-gray-800">Loading</h2>):(
          ...
          <form className="max-w-md md:ml-auto w-full block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow ">
